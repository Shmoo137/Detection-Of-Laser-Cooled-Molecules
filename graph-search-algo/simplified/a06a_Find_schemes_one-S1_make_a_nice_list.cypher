//a06a Find schemes with one S1 + make a nice list
...
match (s1)-[r2:DECAY]->(s2) where r2.energy_diff > min_laser_nm and r2.energy_diff < max_laser_nm and r2.branching_ratio > br_cutoff and s2.J < max_J
