...
with 5 as num_decays_per_subscheme, 428 as s0_id, 722 as s1_id, 728 as s1prim_id, 250 as min_laser_nm, 10000 as max_laser_nm, 1e-7 as br_cutoff, 4 as max_J

match (s2:ReachableState)<-[r12prim:DECAY]-(s1prim:ReachableExcitedState)-[r10prim:DECAY]->(s0:EnergyWiseStartingState)<-[r10:DECAY]-(s1:ReachableExcitedState)-[r12:DECAY]->(s2:ReachableState) where s0.id = s0_id and s1.id = s1_id and s1prim.id = s1prim_id and r10.energy_diff > min_laser_nm and r10.energy_diff < max_laser_nm and r10prim.energy_diff > min_laser_nm and r10prim.energy_diff < max_laser_nm and s0.J < max_J and s1.J < max_J and s1prim.J < max_J and r12.energy_diff > min_laser_nm and r12.energy_diff < max_laser_nm and r12.branching_ratio > br_cutoff and r12prim.energy_diff > min_laser_nm and r12prim.energy_diff < max_laser_nm and r12prim.branching_ratio > br_cutoff and s2.J < max_J
