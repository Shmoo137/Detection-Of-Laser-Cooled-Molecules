// 08b Find double-S1 schemes + make a nice list
with 10 as num_decays_per_subscheme, 250 as min_laser_nm, 10000 as max_laser_nm, 1e-7 as br_cutoff, 1e-6 as min_starting_tau, 4 as max_J, 0.5 as S1_taus_max_perc_diff
